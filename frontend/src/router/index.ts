...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/backup/:id/edit", name: "backup-edit", component: () => import("../views/BackupEdit.vue") },
    ...
    { path: "/migration/:id/edit", name: "migration-edit", component: () => import("../views/MigrationEdit.vue") },
    ...
    { path: "/log-detail", name: "log-detail", component: () => import("../views/LogDetail.vue") },
  ],
});
